...
String qry;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		qry="Select UserId,Password from admin where UserId='"+jTextField1.getText()+"' and Password='"+jPasswordField1.getText()+"'";
		rs=st.executeQuery(qry);
                ...
                JOptionPane.showMessageDialog(null, "Admin Id And Password is Incorrect Or Could Not Found in Database");
                }
